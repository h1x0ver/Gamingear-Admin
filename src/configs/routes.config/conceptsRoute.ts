...
const conceptsRoute: Routes = [
...

    {
        ...
        component: lazy(
            () => import('@/views/concepts/categories/CategoryCreate/CategoryCreate'),
        ),
        authority: [ADMIN, USER],
        meta: {
            header: {
                ...
                description:
                    'Quickly add category to your inventory. Enter key details, manage stock, and set availability.',
                contained: true,
            },
            footer: false,
        },
    },
    {
        ...
        component: lazy(
            () => import('@/views/concepts/categories/categoryList/CategoryList'),
        ),
        authority: [ADMIN, USER],
        meta: {
            header: {
...

    {
        ...
        component: lazy(
            () => import('@/views/concepts/brand/BrandCreate/BrandCreate'),
        ),
        authority: [ADMIN, USER],
        meta: {
            header: {
                title: 'create brand',
                description:
                    'Quickly add brand to your inventory. Enter key details, manage stock, and set availability.',
                contained: true,
            },
            footer: false,
        },
    },
    {
        ...
        component: lazy(
            () => import('@/views/concepts/brand/BrandList/BrandList'),
        ),
        authority: [ADMIN, USER],
        meta: {
            header: {
